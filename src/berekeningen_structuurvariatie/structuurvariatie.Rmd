...
```{r semivarianceplots, fig.cap="(ref:semivarianceplots)"}
aa <- pb_plot_chm %>%
...
Figuur \@ref(fig:gradmag-proefvlakken) toont de gradiëntsterkte binnen de proefvlakken. Dus ook in lage vegetaties (< 2m) geeft deze kaart aan waar de overgangen zijn en hoe sterk deze zijn.
