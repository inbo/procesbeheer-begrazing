...
Via deze link vinden jullie een geo tiff-bestand met een resolutie; pixelgrootte = 2,5 cm x 2,5 cm . Elke cel vertegenwoordigt dus een oppervlakte van 6,25 cm².
...
```{r read-tif}
tif_file <- find_root_file("dronebeelden", "raster_test.tif",
...
```{r read-sheet}
gcp <- read_sheet(ss = "https://docs.google.com/spreadsheets/d/1OFLXjb2_jUbbNla9OHMuLnyro93bbkh1pJHcjcZsuM8/edit#gid=78378400", sheet = "zwin_4mei2020_voorR")
