...
Met behulp van het `googledrive` package, kunnen deze bestanden gedownload worden naar de map `dronebeelden/`. 
Alle bestanden in deze map worden genegeerd door het versiebeheer. 
